...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(null, "João Antunes", "joazinho_antunes@gmail.com", "13465278", "-"));
	...
	@Test
	@DisplayName("Não deve permitir duplicaão do Usuário")
	public void naoDeveDuplicarUsuario() {

		usuarioService.cadastrarUsuario(new Usuario(null, "Maria da Silva", "maria_silva@gmail.com.br", "1345678", "-"));

		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(null, "Maria da Silva", "maria_silva@gmail.com.br", "1345678", "-"));
